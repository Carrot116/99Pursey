...
if($state=="all"){
	$sql1=hxl_mysql_query("select count(*) as total from tb_leaguerinfo  where type='$type' order by id");
}else{
	$sql1=hxl_mysql_query("select count(*) as total from tb_leaguerinfo  where type='$type' and checkstate=$state order by id");
}
...
//}
if($state=="all"){
	$sql=hxl_mysql_query("select * from tb_leaguerinfo  where type='$type' order by id limit ".($page-1)*$pagesize.",$pagesize");
}else{
	$sql=hxl_mysql_query("select * from tb_leaguerinfo  where type='$type' and checkstate=$state order by id limit ".($page-1)*$pagesize.",$pagesize");
}
