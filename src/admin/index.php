...
<frameset rows="*" cols="1*,1005,1*" framespacing="0" frameborder="NO" border="0">
  	<frame src="blank.php" name="left" scrolling="YES" noresize>
  	<frameset rows="1005,*" cols="*" framespacing="0" frameborder="NO" border="0">
		<frameset rows="94,*,20" cols="*" framespacing="0" frameborder="NO" border="0">
            ...
            <frameset  rows="*" cols="235,*"  framespacing="0" frameborder="NO" border="0">
                ...
                <frame src="main.php" name="mainFrame" scrolling="YES" noresize>
            </frameset>
