...
if($flag=="all"){
	$sql1=hxl_mysql_query("select count(*) as total from tb_advertising order by flag desc");
}else{
	$sql1=hxl_mysql_query("select count(*) as total from tb_advertising where flag='$flag' order by flag desc");
}
...
//}
if($flag=="all"){
	$sql=hxl_mysql_query("select * from tb_advertising order by flag desc limit ".($page-1)*$pagesize.",$pagesize");
}else{
	$sql=hxl_mysql_query("select * from tb_advertising where flag='$flag' order by flag desc limit ".($page-1)*$pagesize.",$pagesize");
}
