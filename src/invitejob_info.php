    ...
    <td width="563" height="587" valign="top" bgcolor="#FFFFFF"><table width="563" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="96" align="center" valign="top"><br>
          <?php
			$date1=date("Y-m-d");
			$sgsql=hxl_mysql_query("select * from tb_leaguerinfo  where type='招聘信息' and showday>='$date1' and checkstate=1 ");
...
<br>
<?php
$sql=hxl_mysql_query("select count(*) as total from tb_info where type='招聘信息' and checkstate=1");
...
//}
$gsql=hxl_mysql_query("select * from tb_info where type='招聘信息' and checkstate=1 order by edate desc limit ".($page-1)*$pagesize.",$pagesize");
