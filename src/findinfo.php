        ...
        <td width="563" height="587" valign="top" bgcolor="#FFFFFF"><table width="563" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="center" valign="top">
				...
				$sql1=hxl_mysql_query("select * from tb_leaguerinfo  where checkstate=1 and type='$type' and (content like'%$content%' or title like'%$content%' or linkman like'%$content%' or tel like'%$content%')");
				$info1=hxl_mysql_fetch_array($sql1);
				$sql=hxl_mysql_query("select * from tb_info  where checkstate=1 and type='$type' and (content like'%$content%' or title like'%$content%' or linkman like'%$content%' or tel like'%$content%')");
			   ...
			   ?>
                ...
                <?php
				}while($info1=hxl_mysql_fetch_array($sql1));
				?>
				</td>
            </tr>
            <tr>
